...
.border-back-ground-primary {
  --tw-border-opacity: 1;
  border-color: rgb(131 45 152 / var(--tw-border-opacity));
}

.border-back-ground-primary-light {
  --tw-border-opacity: 1;
  border-color: rgb(222 187 230 / var(--tw-border-opacity));
}
...
.border-others-primary-push {
  --tw-border-opacity: 1;
  border-color: rgb(77 25 89 / var(--tw-border-opacity));
}
...
.border-others-sidebar-bottom {
  --tw-border-opacity: 1;
  border-color: rgb(233 140 244 / var(--tw-border-opacity));
}
...
.\\!bg-back-ground-primary-light {
  ...
  background-color: rgb(222 187 230 / var(--tw-bg-opacity)) !important;
}
...
.bg-back-ground-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(131 45 152 / var(--tw-bg-opacity));
}

.bg-back-ground-primary-light {
  --tw-bg-opacity: 1;
  background-color: rgb(222 187 230 / var(--tw-bg-opacity));
}
...
.bg-others-primary-push {
  --tw-bg-opacity: 1;
  background-color: rgb(77 25 89 / var(--tw-bg-opacity));
}
...
.bg-others-sidebar-bottom {
  --tw-bg-opacity: 1;
  background-color: rgb(233 140 244 / var(--tw-bg-opacity));
}
...
.from-others-sidebar-top {
  --tw-gradient-from: #832d98 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(131 45 152 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.to-others-sidebar-bottom {
  --tw-gradient-to: #E98CF4 var(--tw-gradient-to-position);
}
...
.text-back-ground-primary {
  --tw-text-opacity: 1;
  color: rgb(131 45 152 / var(--tw-text-opacity));
}

.text-back-ground-primary-light {
  --tw-text-opacity: 1;
  color: rgb(222 187 230 / var(--tw-text-opacity));
}
...
.text-others-primary-push {
  --tw-text-opacity: 1;
  color: rgb(77 25 89 / var(--tw-text-opacity));
}
...
.text-others-sidebar-bottom {
  --tw-text-opacity: 1;
  color: rgb(233 140 244 / var(--tw-text-opacity));
}
...
.shadow-input-focus {
  --tw-shadow: 0px 0px 6px 0px #832d98;
