...
.border-back-ground-primary {
  --tw-border-opacity: 1;
  border-color: rgb(46 51 165 / var(--tw-border-opacity));
}

.border-back-ground-primary-light {
  --tw-border-opacity: 1;
  border-color: rgb(201 203 243 / var(--tw-border-opacity));
}
...
.border-others-sidebar-bottom {
  --tw-border-opacity: 1;
  border-color: rgb(190 193 251 / var(--tw-border-opacity));
}
...
.border-text-primary {
  --tw-border-opacity: 1;
  border-color: rgb(69 76 227 / var(--tw-border-opacity));
}
...
.\\!bg-back-ground-primary-light {
  ...
  background-color: rgb(201 203 243 / var(--tw-bg-opacity)) !important;
}
...
.bg-back-ground-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(46 51 165 / var(--tw-bg-opacity));
}

.bg-back-ground-primary-light {
  --tw-bg-opacity: 1;
  background-color: rgb(201 203 243 / var(--tw-bg-opacity));
}
...
.bg-others-sidebar-bottom {
  --tw-bg-opacity: 1;
  background-color: rgb(190 193 251 / var(--tw-bg-opacity));
}
...
.bg-text-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(69 76 227 / var(--tw-bg-opacity));
}
...
.from-others-sidebar-top {
  --tw-gradient-from: #2e33a5 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(46 51 165 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.to-others-sidebar-bottom {
  --tw-gradient-to: #BEC1FB var(--tw-gradient-to-position);
}
...
.text-back-ground-primary {
  --tw-text-opacity: 1;
  color: rgb(46 51 165 / var(--tw-text-opacity));
}

.text-back-ground-primary-light {
  --tw-text-opacity: 1;
  color: rgb(201 203 243 / var(--tw-text-opacity));
}
...
.text-others-sidebar-bottom {
  --tw-text-opacity: 1;
  color: rgb(190 193 251 / var(--tw-text-opacity));
}
...
.text-text-primary {
  --tw-text-opacity: 1;
  color: rgb(69 76 227 / var(--tw-text-opacity));
}
...
.shadow-input-focus {
  --tw-shadow: 0px 0px 6px 0px #2e33a5;
