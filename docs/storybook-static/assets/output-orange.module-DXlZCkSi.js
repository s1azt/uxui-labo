...
.border-back-ground-primary {
  --tw-border-opacity: 1;
  border-color: rgb(242 103 12 / var(--tw-border-opacity));
}

.border-back-ground-primary-light {
  --tw-border-opacity: 1;
  border-color: rgb(254 242 235 / var(--tw-border-opacity));
}
...
.border-others-primary-push {
  --tw-border-opacity: 1;
  border-color: rgb(214 93 13 / var(--tw-border-opacity));
}
...
.\\!bg-back-ground-primary-light {
  ...
  background-color: rgb(254 242 235 / var(--tw-bg-opacity)) !important;
}
...
.bg-back-ground-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(242 103 12 / var(--tw-bg-opacity));
}
...
.bg-others-primary-push {
  --tw-bg-opacity: 1;
  background-color: rgb(214 93 13 / var(--tw-bg-opacity));
}
...
.from-others-sidebar-top {
  --tw-gradient-from: #F2670C var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(242 103 12 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.to-others-sidebar-bottom {
  --tw-gradient-to: #FEF2EB var(--tw-gradient-to-position);
}
...
.text-back-ground-primary {
  --tw-text-opacity: 1;
  color: rgb(242 103 12 / var(--tw-text-opacity));
}

.text-back-ground-primary-light {
  --tw-text-opacity: 1;
  color: rgb(254 242 235 / var(--tw-text-opacity));
}
...
.text-others-primary-push {
  --tw-text-opacity: 1;
  color: rgb(214 93 13 / var(--tw-text-opacity));
}
...
.shadow-input-focus {
  --tw-shadow: 0px 0px 6px 0px #F2670C;
