...
.border-back-ground-primary {
  --tw-border-opacity: 1;
  border-color: rgb(27 79 9 / var(--tw-border-opacity));
}

.border-back-ground-primary-light {
  --tw-border-opacity: 1;
  border-color: rgb(196 221 170 / var(--tw-border-opacity));
}
...
.border-others-primary-push {
  --tw-border-opacity: 1;
  border-color: rgb(24 70 8 / var(--tw-border-opacity));
}
...
.border-others-sidebar-bottom {
  --tw-border-opacity: 1;
  border-color: rgb(116 198 139 / var(--tw-border-opacity));
}
...
.\\!bg-back-ground-primary-light {
  ...
  background-color: rgb(196 221 170 / var(--tw-bg-opacity)) !important;
}
...
.bg-back-ground-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(27 79 9 / var(--tw-bg-opacity));
}

.bg-back-ground-primary-light {
  --tw-bg-opacity: 1;
  background-color: rgb(196 221 170 / var(--tw-bg-opacity));
}
...
.bg-others-primary-push {
  --tw-bg-opacity: 1;
  background-color: rgb(24 70 8 / var(--tw-bg-opacity));
}
...
.bg-others-sidebar-bottom {
  --tw-bg-opacity: 1;
  background-color: rgb(116 198 139 / var(--tw-bg-opacity));
}
...
.from-others-sidebar-top {
  --tw-gradient-from: #1b4f09 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(27 79 9 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.to-others-sidebar-bottom {
  --tw-gradient-to: #74C68B var(--tw-gradient-to-position);
}
...
.text-back-ground-primary {
  --tw-text-opacity: 1;
  color: rgb(27 79 9 / var(--tw-text-opacity));
}

.text-back-ground-primary-light {
  --tw-text-opacity: 1;
  color: rgb(196 221 170 / var(--tw-text-opacity));
}
...
.text-others-primary-push {
  --tw-text-opacity: 1;
  color: rgb(24 70 8 / var(--tw-text-opacity));
}
...
.text-others-sidebar-bottom {
  --tw-text-opacity: 1;
  color: rgb(116 198 139 / var(--tw-text-opacity));
}
...
.shadow-input-focus {
  --tw-shadow: 0px 0px 6px 0px #1b4f09;
