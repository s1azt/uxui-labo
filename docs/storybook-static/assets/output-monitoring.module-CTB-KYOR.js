...
.border-back-ground-primary {
  --tw-border-opacity: 1;
  border-color: rgb(43 67 102 / var(--tw-border-opacity));
}
...
.border-others-primary-push {
  --tw-border-opacity: 1;
  border-color: rgb(30 47 74 / var(--tw-border-opacity));
}
...
.\\!bg-back-ground-primary-light {
  ...
  background-color: rgb(232 236 240 / var(--tw-bg-opacity)) !important;
}
...
.bg-back-ground-primary {
  --tw-bg-opacity: 1;
  background-color: rgb(43 67 102 / var(--tw-bg-opacity));
}
...
.bg-others-primary-push {
  --tw-bg-opacity: 1;
  background-color: rgb(30 47 74 / var(--tw-bg-opacity));
}
...
.from-others-sidebar-top {
  --tw-gradient-from: #2B4366 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(43 67 102 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.to-others-sidebar-bottom {
  --tw-gradient-to: #E8ECF0 var(--tw-gradient-to-position);
}
...
.text-back-ground-primary {
  --tw-text-opacity: 1;
  color: rgb(43 67 102 / var(--tw-text-opacity));
}

.text-back-ground-primary-light {
  --tw-text-opacity: 1;
  color: rgb(232 236 240 / var(--tw-text-opacity));
}
...
.text-others-primary-push {
  --tw-text-opacity: 1;
  color: rgb(30 47 74 / var(--tw-text-opacity));
}
...
.shadow-input-focus {
  --tw-shadow: 0px 0px 6px 0px #2B4366;
